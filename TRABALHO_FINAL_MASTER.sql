CREATE DATABASE acidenetes_aeronaves;
USE acidentes_aeronaves;

SET SQL_SAFE_UPDATES = 0;


-- Definição de constraints (usamos a sintaxe simplificada para facilitar leitura)
...
describe tabela_ocorrencia;
-- criamos o campo temporário "ocorrencia_dia_temporario", com isso, praticamos nào apenas uma conversão simples, mas sim obedecendo condicoes REGEXP
-- para fazer de fato uma substituicao, bastava dar um DROP na coluna original e renomear a temporaria.
SELECT * FROM tabela_ocorrencia;

-- JÁ AQUI, ALTERAMOS OS CAMPOS QUE JÁ ESTAVAM NATIVAMENTE NO PADRÃO ISO
SELECT divulgacao_dia_publicacao, COUNT(*) as quantidade
FROM tabela_ocorrencia
WHERE divulgacao_dia_publicacao IS NOT NULL 
  AND divulgacao_dia_publicacao NOT REGEXP '^[0-9]{4}-[0-9]{2}-[0-9]{2}$'  -- não é YYYY-MM-DD
GROUP BY divulgacao_dia_publicacao
ORDER BY quantidade DESC;

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN divulgacao_dia_publicacao DATE;


-- Modificando CAMPOS
-- TABELA OCORRENCIA
ALTER TABLE tabela_ocorrencia
MODIFY COLUMN ocorrencia_classificacao VARCHAR(200);

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN ocorrencia_cidade VARCHAR(200);

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN ocorrencia_uf VARCHAR(200);

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN ocorrencia_pais VARCHAR(200);

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN ocorrencia_aerodromo VARCHAR(200);

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN ocorrencia_hora TIME;

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN investigacao_aeronave_liberada VARCHAR(200);

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN investigacao_status VARCHAR(200);

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN divulgacao_relatorio_publicado VARCHAR(200);

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN divulgacao_dia_publicacao VARCHAR(200);

ALTER TABLE tabela_ocorrencia
MODIFY COLUMN ocorrencia_saida_pista VARCHAR(200);


-- TABELA FATOR CONTRIBUITE
ALTER TABLE tabela_fator_contribuinte
MODIFY COLUMN fator_nome VARCHAR(200);

ALTER TABLE tabela_fator_contribuinte
MODIFY COLUMN fator_aspecto VARCHAR(200);

ALTER TABLE tabela_fator_contribuinte
MODIFY COLUMN fator_condicionante VARCHAR(200);

ALTER TABLE tabela_fator_contribuinte
MODIFY COLUMN fator_area VARCHAR(200); 


-- TABELA AERONAVE
select * from tabela_aeronave;
ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_matricula VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_operador_categoria VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_tipo_veiculo VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_fabricante VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_modelo VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_tipo_icao VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_motor_tipo VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_motor_quantidade VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_assentos INT;

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_pais_fabricante VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_pais_registro VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_registro_categoria VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_registro_segmento VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_voo_origem VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_voo_destino VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_fase_operacao VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_tipo_operacao VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_nivel_dano VARCHAR(200);

ALTER TABLE tabela_aeronave
MODIFY COLUMN aeronave_ano_fabricacao YEAR;


-- TABELA TIPO OCORRENCIA
ALTER TABLE tabela_tipo_ocorrencia
MODIFY COLUMN ocorrencia_tipo VARCHAR(300);

ALTER TABLE tabela_tipo_ocorrencia
MODIFY COLUMN ocorrencia_tipo_categoria VARCHAR(300);

ALTER TABLE tabela_tipo_ocorrencia
MODIFY COLUMN taxonomia_tipo_icao VARCHAR(50);


-- TABELA RECOMENDACAO SEGURANCA
SELECT * FROM tabela_recomendacao_seguranca;
-- PADRAO DE DATA ISO
ALTER TABLE tabela_recomendacao_seguranca
MODIFY COLUMN recomendacao_dia_assinatura DATE;

ALTER TABLE tabela_recomendacao_seguranca
MODIFY COLUMN recomendacao_dia_encaminhamento DATE;

ALTER TABLE tabela_recomendacao_seguranca
MODIFY COLUMN recomendacao_dia_feedback DATE;
